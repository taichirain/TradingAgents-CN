...
=======
| 🤖 AI模型集成 | 3          | 硅基流动LLM提供商支持、日志系统修复、Gemini端点修复 |
>>>>>>> c1955cf (feat: complete Qianfan integration with documentation updates and fixes)
>>>>>>> 3bd02d7 (feat: complete Qianfan integration with documentation updates and fixes)
